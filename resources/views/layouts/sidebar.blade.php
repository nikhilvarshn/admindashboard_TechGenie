        ...
        <div class="main-navbar" style="height:100%;">
          ...
          <div id="mainnav" style="height:100%;">           
            <ul class="nav-menu custom-scrollbar" style="height:100%;padding-bottom:120px;">
              ...
              <li class="dropdown"><a class="nav-link menu-title link-nav my-2" href="{{url('/totaluser')}}" id="fir"><i data-feather="users"></i><span>Total User</span></a></li>
              ...
              {{-- <li class="dropdown"><a class="nav-link menu-title" href="javascript:void(0)"><i data-feather="users"></i><span>Users</span></a>
                <ul class="nav-submenu menu-content">
                  ...
                  <li><a href="/activeuser">Active User</a></li>
